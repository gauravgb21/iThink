...
router.get('/:userid',function(req,res){
	...
	User.find({username:req.params.userid},{_id:1,username:1,name:1,bio:1,profession:1,city:1,country:1,birthday:1,imageUrl:1,following:1,followers:1},function(err,data){
		if(err)throw err;
		user._id        = data[0]._id;
